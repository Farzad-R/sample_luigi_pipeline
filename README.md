...
Luigi tasks can contain three different parts, requires, output, and run. However, the way you use these three methods vary based on your needs. In this pipeline, I didn't use the requires method. Also, output is just used to create the new output directory for that specific task. Check the [documentation](https://luigi.readthedocs.io/en/stable/tasks.html) for further information of how you can use luigi pipelines.
